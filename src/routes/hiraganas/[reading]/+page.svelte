...
<svelte:head>
    <title>{data.kana.reading} - Hiragana - KanaSchool</title>
    <meta name="description" content="Learn about the hiragana character {data.kana.unicode} ({data.kana.reading})." />
    <meta property="og:title" content="{data.kana.reading} - Hiragana - KanaSchool" />
    <meta
        property="og:description"
        content="Learn about the hiragana character {data.kana.unicode} ({data.kana.reading})."
    />
...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <a href="/hiraganas" class="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline">
            Back to Hiragana
        </a>
    </div>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-blue-50 p-6">
                        ...
                        <div class="flex gap-6">
                            <div class="text-center">
                                ...
                                <p class="text-sm text-gray-600">Shi (し)</p>
                            </div>
                            <div class="text-center">
                                <div class="mb-2 text-6xl font-bold">{data.alternativeKana.unicode}</div>
                                <p class="text-sm text-gray-600">Chi (ち)</p>
                            </div>
                        </div>
                    </div>
                {/if}
