...
<svelte:head>
    <title>Katakana - KanaSchool</title>
    <meta name="description" content="Explore and learn all katakana characters." />
    <meta property="og:title" content="Katakana - KanaSchool" />
    <meta property="og:description" content="Explore and learn all katakana characters." />
    <meta property="og:type" content="website" />
</svelte:head>

<div class="container mx-auto px-4 py-8">
    <div class="mb-8 flex items-center justify-between">
        <h1 class="text-4xl font-bold">Katakana</h1>
        <a
